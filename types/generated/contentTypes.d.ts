...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    admin_in_organizations: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::organization.organization'
    >;
...
export interface ApiEmailEmail extends Schema.SingleType {
  ...
  attributes: {
    from: Attribute.String & Attribute.DefaultTo<'noreply@denalify.com'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiOrganizationOrganization extends Schema.CollectionType {
  ...
  attributes: {
    ...
    admin_users: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    plan: Attribute.Enumeration<['free', 'small', 'big']> &
      Attribute.Private &
      Attribute.DefaultTo<'free'>;
    inviteCode: Attribute.UID & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::organization.organization',
...
export interface ApiPojectPoject extends Schema.CollectionType {
...
export interface ApiTaskTask extends Schema.CollectionType {
  ...
  attributes: {
    ...
    users: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    priority: Attribute.Enumeration<['none', 'normal', 'important']>;
    comments: Attribute.Relation<
      'api::task.task',
      'oneToMany',
      'api::comment.comment'
    ...
    subtask: Attribute.Component<'task.subtask', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::poject.poject': ApiPojectPoject;
